    ...
    $router->group(['prefix' => 'admin', 'middleware' => 'auth.admin'], function () use ($router) {
        $router->group(['prefix' => 'subscriptions'], function () use ($router) {
            $router->group(['middleware' => ['filter.json']], function () use ($router) {
                ...
                $router->post('/{subscription_id}/personal-tokens', 'Auth\PersonalTokenController@CreatePersonalToken');
                $router->put('/{subscription_id}/personal-tokens/{token_id}', 'Auth\PersonalTokenController@UpdatePersonalToken');
            ...
            $router->delete('/{subscription_id}/personal-tokens/{token_id}', 'Auth\PersonalTokenController@DeletePersonalToken');
            $router->put('/{subscription_id}/personal-tokens/{token_id}/reset', 'Auth\PersonalTokenController@ResetPersonalToken');
            $router->get('/{subscription_id}/personal-tokens/{token_id}', 'Auth\PersonalTokenController@GetPersonalToken');
            $router->get('/{subscription_id}/personal-tokens', 'Auth\PersonalTokenController@GetPersonalTokens');
        });
